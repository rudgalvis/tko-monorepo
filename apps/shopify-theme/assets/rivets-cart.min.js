...
// license: MIT
"undefined" == typeof Shopify && (window.Shopify = {}), "undefined" == typeof Shopify.getCart && (Shopify.getCart = function (t, e) {
    return e ? "function" == typeof t ? t(e) : "function" == typeof Shopify.onCartUpdate ? Shopify.onCartUpdate(e) : void 0 : jQuery.getJSON("/cart.js", function (e, i, n) {
        return "function" == typeof t ? t(e, i, n) : "function" == typeof Shopify.onCartUpdate ? Shopify.onCartUpdate(e) : void 0
    })
}), function () {
    function t(t, i, n, r) {
    ...
    t.adapters = {}, e.tokenize = function (t, e, i) {
        var n, r, s = [], o = {i: i, path: ""};
        for (n = 0; n < t.length; n++) r = t.charAt(n), ~e.indexOf(r) ? (s.push(o), o = {i: r, path: ""}) : o.path += r;
        return s.push(o), s
    }, e.prototype.parse = function () {
        var i, r, s = this.interfaces();
        s.length || n("Must define at least one adapter interface."), ~s.indexOf(this.keypath[0]) ? (i = this.keypath[0], r = this.keypath.substr(1)) : ("undefined" == typeof (i = this.options.root || t.root) && n("Must define a default root adapter."), r = this.keypath), this.tokens = e.tokenize(r, s, i), this.key = this.tokens.pop()
    }, e.prototype.realize = function () {
        var t, e = this.obj, n = !1;
        return this.tokens.forEach(function (r, s) {
            i(e) ? ("undefined" != typeof this.objectPath[s] ? e !== (t = this.objectPath[s]) && (this.set(!1, r, t, this.update), this.set(!0, r, e, this.update), this.objectPath[s] = e) : (this.set(!0, r, e, this.update), this.objectPath[s] = e), e = this.get(r, e)) : (n === !1 && (n = s), (t = this.objectPath[s]) && this.set(!1, r, t, this.update))
    ...
    t = {
        ...
        "public": {
            ...
            configure: function (e) {
                var i, n, r, s;
                null == e && (e = {});
                for (r in e) if (s = e[r], "binders" === r || "components" === r || "formatters" === r || "adapters" === r) for (n in s) i = s[n], t[r][n] = i; else t["public"][r] = s
            },
            bind: function (e, i, n) {
                var r;
            ...
            init: function (e, i, n) {
                var r, s;
                return null == n && (n = {}), null == i && (i = document.createElement("div")), e = t["public"].components[e], i.innerHTML = e.template.call(this, i), r = e.initialize.call(this, i, n), s = new t.View(i, r), s.bind(), s
            }
        }
        ...
        return t.types = {primitive: 0, keypath: 1}, t.parse = function (t) {
            return /^'.*'$|^".*"$/.test(t) ? {
                ...
                type: this.types.primitive,
                value: void 0
            } : isNaN(Number(t)) === !1 ? {type: this.types.primitive, value: Number(t)} : {
        ...
        return t.types = {text: 0, binding: 1}, t.parse = function (t, e) {
            ...
            for (u = [], s = t.length, i = 0, n = 0; s > n;) {
                ...
                a = t.slice(n, i).trim(), u.push({type: this.types.binding, value: a}), n = i + e[1].length
            }
            return u
        }, t
    }(), t.View = function () {
        function e(e, i, n) {
            var s, o, u, a, l, h, c, d, p, f, v, y, b;
            for (this.els = e, this.models = i, null == n && (n = {}), this.update = r(this.update, this), this.publish = r(this.publish, this), this.sync = r(this.sync, this), this.unbind = r(this.unbind, this), this.bind = r(this.bind, this), this.select = r(this.select, this), this.traverse = r(this.traverse, this), this.build = r(this.build, this), this.buildBinding = r(this.buildBinding, this), this.bindingRegExp = r(this.bindingRegExp, this), this.options = r(this.options, this), this.els.jquery || this.els instanceof Array || (this.els = [this.els]), p = t.extensions, l = 0, c = p.length; c > l; l++) {
                if (o = p[l], this[o] = {}, n[o]) {
                    f = n[o];
                    for (s in f) u = f[s], this[o][s] = u
                }
                v = t["public"][o];
                for (s in v) u = v[s], null == (a = this[o])[s] && (a[s] = u)
            }
            for (y = t.options, h = 0, d = y.length; d > h; h++) o = y[h], this[o] = null != (b = n[o]) ? b : t["public"][o];
            this.build()
        }
        ...
        return e.prototype.options = function () {
            ...
            return l = {}, c = function () {
                var t, e, i, n;
                for (i = r.split("|"), n = [], t = 0, e = i.length; e > t; t++) h = i[t], n.push(h.trim());
                return n
            }(), s = function () {
                var t, e, i, n;
                for (i = c.shift().split("<"), n = [], t = 0, e = i.length; e > t; t++) o = i[t], n.push(o.trim());
                return n
            }(), a = s.shift(), l.formatters = c, (u = s.shift()) && (l.dependencies = u.split(/\s+/)), this.bindings.push(new t[e](this, i, n, a, l))
        }, e.prototype.build = function () {
            var e, i, n, r, s;
            for (this.bindings = [], i = function (e) {
                return function (n) {
                    var r, s, o, u, a, l, h, c, d, p, f, v, y, b;
                    if (3 === n.nodeType) {
                        if (a = t.TextTemplateParser, (o = e.templateDelimiters) && (c = a.parse(n.data, o)).length && (1 !== c.length || c[0].type !== a.types.text)) {
                            for (d = 0, f = c.length; f > d; d++) h = c[d], l = document.createTextNode(h.value), n.parentNode.insertBefore(l, n), 1 === h.type && e.buildBinding("TextBinding", l, null, h.value);
                    ...
                    if (!r) {
                        for (y = function () {
                            ...
                            return r
                        }(), b = [], p = 0, v = y.length; v > p; p++) s = y[p], b.push(i(s));
                        return b
                    }
                }
            ...
            var i, n, r, s, o, u, a, l, h, c, d, p, f, v, y, b;
            for (s = this.bindingRegExp(), o = "SCRIPT" === e.nodeName || "STYLE" === e.nodeName, v = e.attributes, c = 0, p = v.length; p > c; c++) if (i = v[c], s.test(i.name)) {
                if (l = i.name.replace(s, ""), !(r = this.binders[l])) {
                    y = this.binders;
                    for (u in y) h = y[u], "*" !== u && -1 !== u.indexOf("*") && (a = new RegExp("^" + u.replace(/\*/g, ".+") + "$"), a.test(l) && (r = h))
                }
                r || (r = this.binders["*"]), r.block && (o = !0, n = [i])
            }
            for (b = n || e.attributes, d = 0, f = b.length; f > d; d++) i = b[d], s.test(i.name) && (l = i.name.replace(s, ""), this.buildBinding("Binding", e, l, i.value));
            return o || (l = e.nodeName.toLowerCase(), this.components[l] && !e._bound && (this.bindings.push(new t.ComponentBinding(this, e, l)), o = !0)), o
            ...
            var t, e, i, n, r;
            for (n = this.bindings, r = [], e = 0, i = n.length; i > e; e++) t = n[e], r.push(t.bind());
            return r
        }, e.prototype.unbind = function () {
            var t, e, i, n, r;
            for (n = this.bindings, r = [], e = 0, i = n.length; i > e; e++) t = n[e], r.push(t.unbind());
            return r
        }, e.prototype.sync = function () {
            var t, e, i, n, r;
            for (n = this.bindings, r = [], e = 0, i = n.length; i > e; e++) t = n[e], r.push("function" == typeof t.sync ? t.sync() : void 0);
            return r
            ...
            for (o = this.bindings, u = [], r = 0, s = o.length; s > r; r++) e = o[r], u.push("function" == typeof e.update ? e.update(t) : void 0);
            return u
        }, e
    }(), t.Binding = function () {
        ...
        return e.prototype.setBinder = function () {
            ...
            var i, n, r, o, u, a, l, h, c, d, p, f, v, y;
            for (y = this.formatters, o = d = 0, f = y.length; f > d; o = ++d) {
                for (u = y[o], r = u.match(/[^\s']+|'([^']|'[^\s])*'|"([^"]|"[^\s])*"/g), a = r.shift(), u = this.view.formatters[a], r = function () {
                    var e, i, s;
                    for (s = [], e = 0, i = r.length; i > e; e++) n = r[e], s.push(t.TypeParser.parse(n));
                    return s
                }(), h = [], i = p = 0, v = r.length; v > p; i = ++p) n = r[i], h.push(0 === n.type ? n.value : ((c = this.formatterObservers)[o] || (c[o] = {}), (l = this.formatterObservers[o][i]) ? void 0 : (l = this.observe(this.view.models, n.value, this.sync), this.formatterObservers[o][i] = l), l.value()));
                (null != u ? u.read : void 0) instanceof Function ? e = u.read.apply(u, [e].concat(s.call(h))) : u instanceof Function && (e = u.apply(null, [e].concat(s.call(h))))
            }
            return e
            ...
            return this.set(function () {
                ...
                if (this.observer) {
                    if (this.model !== this.observer.target) {
                        ...
                        if (this.dependencies = [], null != (this.model = this.observer.target) && (null != (u = this.options.dependencies) ? u.length : void 0)) for (a = this.options.dependencies, n = 0, s = a.length; s > n; n++) t = a[n], e = this.observe(this.model, t, this.sync), this.dependencies.push(e)
                    }
            ...
            var t, e, i, n, r, o, u, a, l;
            if (this.observer) {
                for (n = this.getValue(this.el), u = this.formatters.slice(0).reverse(), r = 0, o = u.length; o > r; r++) e = u[r], t = e.split(/\s+/), i = t.shift(), (null != (a = this.view.formatters[i]) ? a.publish : void 0) && (n = (l = this.view.formatters[i]).publish.apply(l, [n].concat(s.call(t))));
                return this.observer.setValue(n)
            }
        }, e.prototype.bind = function () {
            var t, e, i, n, r, s, o;
            if (this.parseTarget(), null != (r = this.binder.bind) && r.call(this, this.el), null != this.model && (null != (s = this.options.dependencies) ? s.length : void 0)) for (o = this.options.dependencies, i = 0, n = o.length; n > i; i++) t = o[i], e = this.observe(this.model, t, this.sync), this.dependencies.push(e);
            return this.view.preloadData ? this.sync() : void 0
        }, e.prototype.unbind = function () {
            var t, e, i, n, r, s, o, u, a, l;
            for (null != (o = this.binder.unbind) && o.call(this, this.el), null != (u = this.observer) && u.unobserve(), a = this.dependencies, r = 0, s = a.length; s > r; r++) n = a[r], n.unobserve();
        ...
        function i(t, e, i) {
            var n, s, o, u, l, h, c;
            for (this.view = t, this.el = e, this.type = i, this.unbind = r(this.unbind, this), this.bind = r(this.bind, this), this.locals = r(this.locals, this), this.component = this.view.components[this.type], this["static"] = {}, this.observers = {}, this.upstreamObservers = {}, s = t.bindingRegExp(), h = this.el.attributes || [], u = 0, l = h.length; l > u; u++) n = h[u], s.test(n.name) || (o = this.camelCase(n.name), a.call(null != (c = this.component["static"]) ? c : [], o) >= 0 ? this["static"][o] = n.value : this.observers[o] = n.value)
        }

        return u(i, e), i.prototype.sync = function () {
            ...
            var e, i, n, r, s, o, u, a, l, h, c, d, p, f, v, y, b, m, g, w, C;
            if (!this.bound) {
                f = this.observers;
            ...
            for (this.el.innerHTML = this.component.template.call(this), u = this.component.initialize.call(this, this.el, this.locals()), this.el._bound = !0, o = {}, v = t.extensions, h = 0, d = v.length; d > h; h++) {
                if (s = v[h], o[s] = {}, this.component[s]) {
                    y = this.component[s];
                    for (e in y) a = y[e], o[s][e] = a
                }
                b = this.view[s];
                for (e in b) a = b[e], null == (l = o[s])[e] && (l[e] = a)
            }
            for (m = t.options, c = 0, p = m.length; p > c; c++) s = m[c], o[s] = null != (g = this.component[s]) ? g : this.view[s];
            this.componentView = new t.View(this.el, u, o), this.componentView.bind(), w = this.observers, C = [];
            for (i in w) r = w[i], C.push(this.upstreamObservers[i] = this.observe(this.componentView.models, i, function (t) {
                return function (e, i) {
                    return function () {
        ...
        publishes: !0, priority: 3e3, bind: function (e) {
            ...
            if (null != window.jQuery) {
                ...
                if (null != e) {
                    for (l = [], n = 0, r = t.length; r > n; n++) i = t[n], l.push(i.selected = (o = i.value, a.call(e, o) >= 0));
                    return l
                }
        ...
        block: !0, priority: 4e3, bind: function (t) {
            var e, i, n, r, s;
            if (null == this.marker) e = [this.view.prefix, this.type].join("-").replace("--", "-"), this.marker = document.createComment(" rivets: " + this.type + " "), this.iterated = [], t.removeAttribute(e), t.parentNode.insertBefore(this.marker, t), t.parentNode.removeChild(t); else for (s = this.iterated, n = 0, r = s.length; r > n; n++) i = s[n], i.bind()
        }, unbind: function () {
            var t, e, i, n, r;
            if (null != this.iterated) {
                for (n = this.iterated, r = [], e = 0, i = n.length; i > e; e++) t = n[e], r.push(t.unbind());
                return r
            }
        }, routine: function (e, i) {
            var n, r, s, o, u, a, l, h, c, d, p, f, v, y, b, m, g, w, C, k, I;
            if (l = this.args[0], i = i || [], this.iterated.length > i.length) for (w = Array(this.iterated.length - i.length), f = 0, b = w.length; b > f; f++) s = w[f], p = this.iterated.pop(), p.unbind(), this.marker.parentNode.removeChild(p.els[0]);
            for (o = v = 0, m = i.length; m > v; o = ++v) if (a = i[o], r = {index: o}, r[l] = a, null == this.iterated[o]) {
                C = this.view.models;
                for (u in C) a = C[u], null == r[u] && (r[u] = a);
                c = this.iterated.length ? this.iterated[this.iterated.length - 1].els[0] : this.marker, h = this.view.options(), h.preloadData = !0, d = e.cloneNode(!0), p = new t.View(d, r, h), p.bind(), this.iterated.push(p), this.marker.parentNode.insertBefore(d, c.nextSibling)
            } else this.iterated[o].models[l] !== a && this.iterated[o].update(r);
            if ("OPTION" === e.nodeName) {
                for (k = this.view.bindings, I = [], y = 0, g = k.length; g > y; y++) n = k[y], I.push(n.el === this.marker.parentNode && "value" === n.type ? n.sync() : void 0);
                return I
            }
        }, update: function (t) {
            var e, i, n, r, s, o, u, a;
            ...
            for (u = this.iterated, a = [], s = 0, o = u.length; o > s; s++) r = u[s], a.push(r.update(e));
            return a
        }
        ...
        id: "_rv", counter: 0, weakmap: {}, weakReference: function (t) {
            ...
            return n = t[e], i = this.weakReference(t), r = this.weakmap, t[e] = function () {
                var e, s, o, u, a, l, h, c, d, p;
                u = n.apply(t, arguments), h = i.pointers;
                for (o in h) for (s = h[o], p = null != (c = null != (d = r[o]) ? d.callbacks[s] : void 0) ? c : [], a = 0, l = p.length; l > a; a++) (e = p[a])();
                return u
            }
        }, observeMutations: function (t, e, i) {
            var n, r, s, o, u, l;
            if (Array.isArray(t)) {
                if (s = this.weakReference(t), null == s.pointers) for (s.pointers = {}, r = ["push", "pop", "shift", "unshift", "sort", "reverse", "splice"], u = 0, l = r.length; l > u; u++) n = r[u], this.stubFunction(t, n);
                if (null == (o = s.pointers)[e] && (o[e] = []), a.call(s.pointers[e], i) < 0) return s.pointers[e].push(i)
            }
            ...
            return n = this.weakReference(t).callbacks, null == n[e] && (n[e] = [], r = Object.getOwnPropertyDescriptor(t, e), (null != r ? r.get : void 0) || (null != r ? r.set : void 0) || (s = t[e], Object.defineProperty(t, e, {
                ...
                set: function (r) {
                    return function (o) {
                        var u, l, h, c;
                        if (o !== s && (r.unobserveMutations(s, t[r.id], e), s = o, u = r.weakmap[t[r.id]])) {
                            if (n = u.callbacks, n[e]) for (c = n[e].slice(), l = 0, h = c.length; h > l; l++) i = c[l], a.call(n[e], i) >= 0 && i();
                            return r.observeMutations(o, t[r.id], e)
                        }
                    }
                }(this)
            }))), a.call(n[e], i) < 0 && n[e].push(i), this.observeMutations(t[e], t[this.id], e)
    ...
    var t, e, i, n, r, s, o, u = function (t, e) {
        return function () {
            return t.apply(e, arguments)
        }
    };
    e = function () {
        ...
        return t.prototype.update = function (t) {
            var e, i, n;
            for (i in t) n = t[i], "items" !== i && (this[i] = n);
            return this.items = function () {
                var i, n, s, o;
                for (s = t.items, o = [], i = 0, n = s.length; n > i; i++) e = s[i], o.push(new r(e));
                return o
            }()
        }, t
    }(), r = function () {
        ...
        return t.prototype.update = function (t) {
            ...
            var t, e, i, n;
            i = this.properties, n = [];
            for (t in i) e = i[t], n.push({name: t, value: e});
            return n
        }, t
    }(), i = {
        settings: {
    ...
    }), n = 'A money formatting filter was used, but Shopify.formatMoney is not available. See the note "Dependency when formatting monetary values" on this page: https://cartjs.org/pages/guide#getting-started-setup.', i.Utils = {
        log: function () {
            ...
            for (n in t) r = t[n], s["" + e + "[" + n + "]"] = null != i ? i : r;
            return s
        }, unwrapKeys: function (t, e, i) {
            var n, r, s, o;
            null == e && (e = "properties"), r = {};
            for (n in t) o = t[n], s = n.replace("" + e + "[", "").replace("]", ""), r[s] = null != i ? i : o;
            return r
        }, extend: function (t, e) {
            var i, n;
        ...
        }, formatMoney: function (t, e, r, s) {
            var o, u;
            return null == s && (s = ""), s || (s = i.settings.currency), null != window.Currency && s !== i.settings.currency && (t = Currency.convert(t, i.settings.currency, s), null != (null != (o = window.Currency) ? o.moneyFormats : void 0) && s in window.Currency.moneyFormats && (e = window.Currency.moneyFormats[s][r])), null != (null != (u = window.Shopify) ? u.formatMoney : void 0) ? Shopify.formatMoney(t, e) : (i.Utils.warn(n), t)
        }, getSizedImageUrl: function (t, e) {
            var i, n;
            return null != (null != (i = window.Shopify) ? null != (n = i.Image) ? n.getSizedImageUrl : void 0 : void 0) ? t ? Shopify.Image.getSizedImageUrl(t, e) : Shopify.Image.getSizedImageUrl("https://cdn.shopify.com/s/images/admin/no-image-.gif", e).replace("-_", "-") : t ? t : "https://cdn.shopify.com/s/images/admin/no-image-large.gif"
        }
    }, o = [], s = !1, i.Queue = {
        add: function (t, e, n) {
            var r;
            ...
            }, n.updateCart && ("undefined" != typeof SECOMAPP && "undefined" != typeof Shopify && "function" == typeof Shopify.getCart ? $.proxy(r.success.push(function (t) {
                Shopify.getCart(function (t) {
                    jQuery(document).trigger("cart:get-cart-complete"),
                    i.cart.update(t), jQuery(document).trigger("cart.requestComplete", [i.cart])
                }, t)
            }), i) : r.success.push(i.cart.update)), o.push(r), s ? void 0 : (jQuery(document).trigger("cart.requestStarted", [i.cart]), i.Queue.process())
        }, process: function () {
            var t;
            return o.length ? (s = !0, t = o.shift(), t.complete = i.Queue.process, jQuery.ajax(t)) : (s = !1,
                jQuery(document).trigger("cart.requestComplete", [i.cart]),
                document.dispatchEvent(new CustomEvent("cart:request-complete")),
                void 0)
        }
    }, i.Core = {
        getCart: function (t) {
            ...
            document.dispatchEvent(new CustomEvent("cart:before-update"))

            return null == e && (e = 1), null == n && (n = {}), null == r && (r = {}), s = i.Utils.wrapKeys(n), s.id = t, s.quantity = e, i.Queue.add("/cart/add.js", s, r), i.Core.getCart()
        }, updateItem: function (t, e, n, r) {
            var s;

            document.dispatchEvent(new CustomEvent("cart:before-update-item"))
            document.dispatchEvent(new CustomEvent("cart:before-update"))

            return null == n && (n = {}), null == r && (r = {}), s = i.Utils.wrapKeys(n), s.line = t, null != e && (s.quantity = e), r.updateCart = !0, i.Queue.add("/cart/change.js", s, r)
            ...
            return null == n && (n = {}), null == r && (r = {}), s = i.Utils.wrapKeys(n), s.id = t, null != e && (s.quantity = e), r.updateCart = !0, i.Queue.add("/cart/change.js", s, r)
            ...
            var r;
            return null == n && (n = {}), r = {}, r[t] = e, i.Core.setAttributes(r, n)
        ...
        init: function () {
            ...
            var t, e;
            return t = jQuery(this), e = t.attr("data-cart-toggle-attribute"), i.Core.setAttribute(e, t.is(":checked") ? "Yes" : "")
        }, submit: function (t) {
            var e, n, r, s;
            return t.preventDefault(), e = jQuery(this).serializeArray(), n = void 0, s = void 0, r = {}, jQuery.each(e, function (t, e) {
                return "id" === e.name ? n = e.value : "quantity" === e.name ? s = e.value : e.name.match(/^properties\[[\w ]+\]$/) ? r[e.name] = e.value : void 0
            }), i.Core.addItem(n, s, i.Utils.unwrapKeys(r))
        }, render: function (t, e) {
            var n;
            return n = {
        ...
        model: null, boundViews: [], init: function () {
            ...
            var t, e, n, r;
            for (r = i.Rivets.boundViews, e = 0, n = r.length; n > e; e++) t = r[e], t.unbind();
